# FintOps - Fintech Media & Learning Platform
...
├── css/
│   └── styles.css    # Custom component styles, overrides, & layout fixes
├── js/
│   └── main.js       # App interactivity (mobile drawer, search, podcast player)
